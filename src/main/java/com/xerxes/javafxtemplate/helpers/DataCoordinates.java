...
//        }
    ...
    private static void writeJsonToFile(List<Map<String, Integer>> dataPointCoordinateArray) throws IOException {
        try {
            FileWriter myWriter = new FileWriter("frameCoordinates.json");
            ObjectMapper objectMapper = new ObjectMapper();
            myWriter.write(objectMapper.writeValueAsString(dataPointCoordinateArray));
            myWriter.close();
        ...
        File file = new File("C:/frameCoordinates.json");
